...
def get_obs_shape(
    ...
    根据状态空间的类型，返回不同的状态数据的维度：https://www.kdocs.cn/l/caeJ9Tgq2Azj?linkname=vusSZKyHg7
    :param observation_space:
    :return:
    """
    if isinstance(observation_space, spaces.Box):
...
def get_action_dim(action_space: spaces.Space) -> int:
    ...
    根据动作空间类型，计算并返回动作数据的维度：https://www.kdocs.cn/l/caeJ9Tgq2Azj?linkname=vusSZKyHg7
    :param action_space:
    :return:
    """
